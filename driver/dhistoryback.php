...
$query = "SELECT b.bookid, b.pickupAddress, b.dropoffAddress, b.bookCompletion,  b.rating, b.fare, b.status, b.commuterID
          FROM booking b
          JOIN commuter c ON b.commuterID = c.commuterID
          WHERE b.plateNumber = '$plateNumber' AND (b.status = 'completed' OR b.status = 'cancelled')
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $query2 = "SELECT firstName, lastName
               FROM commuter
               WHERE commuterID = '" . $row['commuterID'] . "'";
